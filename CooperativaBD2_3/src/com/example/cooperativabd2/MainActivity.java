...
//		}
	...
	public void deptos(View vista){
		Intent vDeptos = new Intent(this, DeptoActivity.class);
		startActivity(vDeptos);
	}
	
	public void profs(View vista){
		Intent vDeptos = new Intent(this, ProfActivity.class);
		startActivity(vDeptos);
	}
