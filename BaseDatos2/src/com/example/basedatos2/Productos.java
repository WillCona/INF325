...
public class Productos {
	...
	public String buscar(String xcod){
		
				String[] columnas = {DES}; 
				String seleccion = COD + " = ?";  
				String[] seleccionArgs = {xcod};  

				Cursor cursor = pBD.query(N_TABLA, columnas, seleccion, seleccionArgs, null, null, null);

				String descripcion = "No existe";

				if (cursor != null && cursor.moveToFirst()) {
				    descripcion = cursor.getString(cursor.getColumnIndex(DES));
				    cursor.close();
				}
